...
def push_up(x, y):
    pygame.draw.rect(screen, red, (x + 1, y - w + 1, 19, 39), 0)         # draw a rectangle twice the width of the cell
...
def backtracking_cell(x, y):
    pygame.draw.rect(screen, red, (x +1, y +1, 18, 18), 0)        # used to re-colour the path after single_cell
